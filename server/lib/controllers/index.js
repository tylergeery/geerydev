...
import GeeryDevClassifier from '../../js/src/containers/GeeryDevClassifier';
...
exports.classifier = function (req, res) {
    res.layout('layouts/main', addToLayoutVars({
            title: 'GeeryDev vs Throwing It Back Weekly - Naive Bayes Classifier',
            script: 'classifier.js',
            stylesheets: ['classifier.css'],
            description: 'A Naive Bayes Text Classifier solution to classifying a given textsearch as either geerydev.com ' +
                'or throwingitbackweekly.wordpress.com. This is a rather simple solution using the Bernoulli document model and LaPlace smoothing.'
        }), {
            content: {
                block: 'classifier',
                data: {
                    classifierString: renderToString(
                        <Provider store={store}>
                            <GeeryDevClassifier />
                        </Provider>
                    )
...
exports.error = function (req, res) {
    res.status(404).layout('layouts/main', addToLayoutVars({
            title: 'GeeryDev 404',
            script: 'common.js',
            stylesheets: []
        }), {
