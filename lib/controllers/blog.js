...
exports.getBlogs = function (req, res) {
    ...
    return blogService
        .query({}, exists, sort, (page - 1) * limit, limit)
        .then(function (blogs) {
...
exports.tibwClassifier = function (req, res) {
    ...
    if (query) {
        /**
         * Solve: p(GD | query)
         * => likelihood = 1lforeach query as q
         *   ( P(query | GD) * P(GD) ) / P(query)
         */
        var tmp = 12;

        // P(query | GD) => # of geerydev posts w/ query /
