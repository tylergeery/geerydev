...
export default class NavBar extends React.Component {
    render() {
        return (
            <div className="col-xs-12 col-md-8 navbar quote">
                ...
                <div className={classNames('col-xs-4 p-xs-none pointer ani-nav', { gdhide: !this.props.showNav })}>
                    <a className="full-width support-nav" href="/requests">
                        <img className="deux" src="images/03980826.blog.png" />
                    </a>
                </div>
                <div className={classNames('col-xs-4 p-xs-none pointer ani-nav-deux', { gdhide: !this.props.showNav })}>
                    <a className="full-width support-nav" href="/portfolio">
                        <img className="un" src="images/ef9707c1.portfolio.png" />
                    </a>
                </div>
                <div className={classNames('col-xs-4 p-xs-none pointer ani-nav-tre', { gdhide: !this.props.showNav })}>
