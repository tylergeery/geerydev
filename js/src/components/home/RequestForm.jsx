...
export default class RequestForm extends FormComponent {
    render() {
        return <form onSubmit={this.ask.bind(this)} className={classNames("form-group px16 pad-box", {'hide': this.props.activePanel !== 'question'})}>
            {!this.state.success
                ? 'Provoke me...'
            ...
            <input className={classNames("form-control m10", {hide: this.state.success})} onKeyUp={this.saveState.bind(this)} type="text" name="name" placeholder="Anonymous" />
