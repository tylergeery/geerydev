...
export default class CommentForm extends FormComponent {
    ...
    render() {
        return (
            <form onSubmit={this.onCommentSubmit.bind(this)} className='comment-form'>
                <div className="col-xs-12 col-sm-offset-1 col-sm-7 form-group mt-20">
            		<label>
                        Name
                        <input type="text" onKeyUp={this.saveState.bind(this)}
                            className="form-control white-back" name="name" placeholder="Anonymous" />
                    </label>
            	</div>
            	<div className="col-xs-12 col-sm-offset-1 col-sm-7 form-group">
            		<label>
                        Email
                        <input type="email" onKeyUp={this.saveState.bind(this)}
                            className="form-control white-back" name="email" />
                    </label>
